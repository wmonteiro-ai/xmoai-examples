...
def train_regression(y_desired_index=1, verbose=False):
    """Train multiple datasets (regression problem) under multiple
    ...
    algorithms = ['AdaBoostRegressor', 'ExtraTreesRegressor', 
                  'GradientBoostingRegressor', 'RandomForestRegressor',
                  'DecisionTreeRegressor', 'LinearSVR', 'Ridge', 
                  'SGDRegressor', 'Lasso', 'KNeighborsRegressor', 
